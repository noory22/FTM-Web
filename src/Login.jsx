...
//           <h1 className="text-7xl font-bold text-gray-800 mb-2 tracking-tight">FTM</h1>
//           <h2 className="text-3xl font-semibold text-blue-600 mb-6 leading-tight">Flexural Testing Machine</h2>
