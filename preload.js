...
contextBridge.exposeInMainWorld("api", {
  ...
  catheterForward: (state) => ipcRenderer.invoke("catheter-forward", state),
  catheterBackward: (state) => ipcRenderer.invoke("catheter-backward", state),
  probeUp: (state) => ipcRenderer.invoke("probe-up", state),
  probeDown: (state) => ipcRenderer.invoke("probe-down", state),
  ...
  writeWeightRange: (value) => ipcRenderer.invoke("write-weight-range", value),
  writeInputsMode: (value) => ipcRenderer.invoke("write-inputs-mode", value),
